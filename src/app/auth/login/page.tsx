      ...
      <div className="max-w-md w-full">
        ...
        >
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <p className="text-white/80 text-sm sm:text-base">Sign in to your Super Sonic Rentals account</p>
          </div>
          ...
          <div className="mt-6 sm:mt-8 text-center space-y-3 sm:space-y-4">
            <button
              ...
              className="text-white/70 hover:text-white transition-colors text-xs sm:text-sm block w-full"
            >
