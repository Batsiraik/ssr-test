...
import { Menu, Bell, FileText, Eye, Fuel, MessageSquare, FileCheck, Upload } from 'lucide-react';
...
export default function ActiveRentalAgreementsPage() {
  ...
  const activeRentalsData: ActiveRentalRow[] = [
    {
      id: 'rg-001',
  ...
  const columns: TableColumn<ActiveRentalRow>[] = [
  ...
  const getRowClassName = (row: ActiveRentalRow) =>
