...
export default function WaitingPOPage() {
  ...
  const workOrdersData: WaitingPORow[] = [
    {
      id: 'wo-po-001',
    ...
    },
    {
      ...
      notes: 'Awaiting P/O from accounting',
      signedPdf: true,
      pdfFileName: '#',
      _actions: '',
    },
  ...
  const columns: TableColumn<WaitingPORow>[] = [
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-semibold text-white">
                  Work Order Waiting for Purchase Order
                </h2>
              </div>
            </motion.div>
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 sm:p-8 shadow-xl border border-white/20">
                <div className="overflow-x-auto">
                  <Table
                    columns={columns}
                    data={workOrdersData}
                    emptyMessage="No Work Orders Waiting"
                    pagination
                    pageSize={25}
                  />
                </div>
