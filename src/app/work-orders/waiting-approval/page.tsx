...
export default function WaitingApprovalPage() {
  ...
  const unsignedData: WaitingApprovalRow[] = [
    {
      id: 'wo-app-001',
  ...
  const columns: TableColumn<WaitingApprovalRow>[] = [
    ...
    { key: 'deliveryDate', title: 'Delivery Date', render: (v) => v || 'N/A' },
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-semibold text-white">
                  Current Work Orders Waiting for Approval
                </h2>
              </div>
            </motion.div>
